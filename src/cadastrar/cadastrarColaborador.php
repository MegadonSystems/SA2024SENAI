...
try{
    ...
    if($formulario['id'] === 'NOVO'){
        ...
        echo json_encode(['status' => 'sucesso', 'mensagem' => 'Calaborador cadastrado com sucesso!']);
    }else{
        ...
        echo json_encode(['status' => 'sucesso', 'mensagem' => 'Calaborador atualizado com sucesso!']);
    }
